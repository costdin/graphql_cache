...
scp build.sh bitnami@192.168.137.128:~/
scp graphql_cache.tar.gz bitnami@192.168.137.128:~/

ssh bitnami@192.168.137.128 "chmod a+x build.sh;./build.sh"
...
scp bitnami@192.168.137.128:~/graphql_cache/target/arm-unknown-linux-musleabi/release/graphql_cache $PATH
